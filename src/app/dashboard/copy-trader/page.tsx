...
export default function CopyTrader() {
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg0)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', fontFamily: 'Inter, system-ui, sans-serif', gap: 12 }}>
      ...
      <div style={{ fontSize: 18, fontWeight: 700, color: 'var(--txt0)' }}>Copy Trader</div>
      <div style={{ fontSize: 13, color: 'var(--txt1)', textAlign: 'center', maxWidth: 320 }}>Mirror the trades of successful traders in real time with configurable risk settings.</div>
